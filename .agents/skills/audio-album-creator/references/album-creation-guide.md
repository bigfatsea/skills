<!-- Ver 2026-06-21, by Claude Opus 4.8 -->
...
- **行长齐**：同段各行字数相近(多 4+3/4+4)，副歌不留 10 字以上长句；砍口语连接词("你们都知道""我自己扛")，叙事炼成意象。
...
## 14. 重写=金标准
"写下来是为了有东西可改"。不信灵感至上/写作障碍——先写烂稿(最好的肥料)，再问"能更具体吗？韵更贴情感吗？行更短吗？"。AI 时代重写=改 brief/七维/歌词+抽卡+局部精修，非反复重生成同一条。
...
- **叠用顺序**：Custom Model(底模)>Persona(嗓)>风格家族三件套(时代+流派+制作)+统一调性。
...
## 27. 版权合规
不可复刻名曲(只做神似+原创词)；艺人名被过滤(翻人声三层)；商用须 Pro 档(约$10/月,V5.5+商用权)并核对当期条款,免费档非商用,credits不结转。
...
## 32. 成品 QC 量规（10项打勾）
①音准稳②咬字可懂无倒字③结构完整无烂尾④无AI瑕疵(金属感/电流/漂移)⑤hook立得住⑥情感与意图一致⑦配器清晰⑧动态有起伏⑨与专辑/Persona一致⑩时长可用。**代表作≥9，底座≥7。** 未达标→精修或回改维度。
...
| 词像散文 | 锁一辙一韵到底、拉齐行长、每段副歌埋对仗、砍口语连接 |
| 产出糊 | 砍到4–7、去冲突项 |
...
## 34. 专辑统筹
一致性栈：Custom Model>Persona>风格家族三件套+统一调性。主题动机：代表作旋律/一句歌词在别曲变奏或器乐复现；题眼复现串动机线。编排：情感弧排序、代表作放高潮位、器乐间奏作呼吸、`[End]`收束、总时长26–30分(8首)。工整vs写意基调(§13.7)：先定工整基调，写意余地0–2首由创作者把控。视角变化制造呼吸。

## 35. 交付规格
WAV母版+320k MP3；统一**-14 LUFS**；实物载体单独核验音量曲序；附封面/曲目表/手写卡。Pro+商用权先核对当期条款。
...
**来源**：Pattison《Writing Better Lyrics》、Berklee Online、songwriting.net(Prosody)；help.suno.com、blakecrosley.com《Suno V5.5 Reference》、jackrighteous.com；人声控制综合hookgenius.app/sider.ai/musci.io等社区实证。**Suno迭代快，Part IV每3–6月复核。**

---

*v3.5 精简版 · 词曲声制作+三大原则+要素词汇库+AI最佳实践+提示词框架 · 配套 song_examples*
*2026-06-21 · by Claude Opus 4.8*
