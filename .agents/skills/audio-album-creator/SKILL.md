...
description: "Turn a creative brief or source material (audio / text / photos) into original song and album assets: write a single song's lyrics, Suno-ready style, and title (3 divergent takes, each with a matching style); design an album-level proposal - theme, narrative arc, track-by-track story/style outline, instrumental/transition placement - without drafting full lyrics; and design 1:1 cover art (3 divergent styles) for an album or single track, with image-gen-ready prompts. Use any standalone, or run end-to-end for a production-ready album plan. Use when the user wants to write a song, turn raw material into an album plan, design an album proposal, or design cover/CD art for a song or album - including life/memorial albums, Amber Ark-style custom albums, or narrative albums for family, a partner, a child, or a team/company. The user names which source files to use, if any. Not for polishing already-written lyrics, pure music-theory Q&A, or generic lyric-writing with no creative brief or narrative material."
---
